...
function CustomerLogin() {
  ...
  const handleGoogleLoginSuccess = async (credentialResponse) => {
    try {
      ...
      const res = await axios.post(`${API_BASE_URL}/api/customers/google-login`, { credential });
  ...
  return (
    <GoogleOAuthProvider clientId="606368754651-i5hbkg61978qc70t2eqet6t92v75n5mf.apps.googleusercontent.com">
